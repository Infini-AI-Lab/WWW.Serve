...
node1_times = poi(rate=1/4, start_time=0, end_time=300) + poi(rate=1/20, start_time=300, end_time=750)
node2_times = poi(rate=1/20, start_time=0, end_time=750)
node3_times = poi(rate=1/20, start_time=0, end_time=750)
node4_times = poi(rate=1/20, start_time=0, end_time=450) + poi(rate=1/4, start_time=450, end_time=750)
