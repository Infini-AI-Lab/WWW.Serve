...
# node1_times = poi(rate=1/2, start_time=0, end_time=300) + poi(rate=1/6, start_time=300, end_time=750)
# node2_times = poi(rate=1/15, start_time=0, end_time=750)
# node3_times = poi(rate=1/30, start_time=0, end_time=750)
# node4_times = poi(rate=1/15, start_time=0, end_time=450) + poi(rate=1/5, start_time=450, end_time=750)
...
node1_times = [4*i for i in range(200)]
