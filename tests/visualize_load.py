...
other_nodes_json = [
    "/home/hywang/Reasoning/Decentralized-Agents/results/test31/test_31_node_1.json",
    "/home/hywang/Reasoning/Decentralized-Agents/results/test31/test_31_node_2.json",
    "/home/hywang/Reasoning/Decentralized-Agents/results/test31/test_31_node_3.json",
    "/home/hywang/Reasoning/Decentralized-Agents/results/test31/test_31_node_4.json"
]
...
for idx, f in enumerate(other_nodes_json):
    ...
    # t = [time for time in t if time < 700]
    # length = len(t)
...
for (t, r), c in zip(zip(other_times, other_tokens), colors):
    # if c == "#D95F02":
    #     plt.plot(t, r, color=c, linewidth=2.0, linestyle='-')
    # else:
    plt.plot(t, r, color=c, linewidth=1.5, linestyle='-')
